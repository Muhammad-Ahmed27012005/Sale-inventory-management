...
import com.inventory.inventory.util.DsaUtil.UndoDeleteStack;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDto updateProduct(Long id, ProductDto productDto) {
        ...
        // Allow partial updates only if values are provided (avoid NPEs)
    ...
    public List<ProductDto> searchProducts(String query) {
        ...
        sorted.stream()
                ...
                .forEach(product -> results.put(product.getProductId(), product));
